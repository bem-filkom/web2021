...
const ArticleCard = ({thumbnail, link, title, date}) => {
  return (
    <Fade bottom>
      <a href={link} target="_blank" rel="noopener noreferrer" className="flex flex-col mx-auto my-4 w-full md:w-80 shadow-md">
        <div style={{backgroundImage : `url("${thumbnail}")`}} className='bg-cover rounded-t-lg bg-center h-80 hidden md:block'/>
