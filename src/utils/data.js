export const departments = [
  ...
  },
  {
    ...
    staff: [
      { name: "Muhammad Zidan Fikri Al Fauzi" },
      { name: "Naira Ghassaani" },
      { name: "Anggraeni Puspa Sari" },
      { name: "Farah Nur A'ini" },
      { name: "Attarik Ramadhan Abdullah" },
      { name: "Nowwil Afqa" },
      { name: "Ifadatul Khoiroh" },
    ],
  },
  {
    id: "perhub",
    ...
    staff: [
      ...
      { name: "Adenawati Hasim" },
      { name: "Aditya Ikhwan Saputro" },
      { name: "Bagus Dermawan Mulya" },
      { name: "Muhammad Ilham Gibran" },
      { name: "Adib Aulia Permana" },
      { name: "Hasna Azlya" },
      { name: "Maharani Fawwaz Ardhani" },
    ],
  },
  {
    id: "kmb",
    ...
    staff: [
      { name: "Arlino Ganda Saputra" },
      { name: "Dara Nurul Idlal Linuwih" },
      { name: "Fito Briantama Setyanto" },
      { name: "Maulana Yusuf" },
      { name: "Sari Rahmawati" },
      { name: "Anatasha Eka Syavina" },
      { name: "Hidayat Mukti Wibowo" },
      { name: "Ni Putu Ramadinda Mahasitadewi" },
      { name: "Utara Setya Wardaya" },
    ],
  },
  {
    id: "kastrat",
    ...
    staff: [
      { name: "Fritz Adriano" },
      { name: "Ariyo Tejo Sumarto" },
      { name: "Azka Isnandaru Fajrina Mulya" },
      { name: "RAKA ARDIANSYAH HASIBUAN" },
      { name: "MUHAMMAD THEOFANY AULIA ANWAR" },
      { name: "Muhammad Rafly Mumtaz" },
      { name: "Geralda Ferrydina Alif" },
      { name: "Aji Rahman Hakim" },
      { name: "Anasya Miftakus Sururi" },
    ],
  },
  {
    id: "sosling",
    ...
    staff: [
      ...
      { name: "Geoffrey Edmund Pierre Purba" },
      { name: "Dwi Anggraeni" },
      { name: "Muhammad Raihan Wardana Budiarto" },
      { name: "Muhammad Davala Safa" },
      { name: "Ratu Salma Al Khairiyah" },
      { name: "Siti Huwaena Maulidiah Sidin" },
      { name: "Mohammad Yusron Jauhari" },
    ],
  },
  {
    id: "advokesma",
    ...
    staff: [
      { name: "Teguh Surya D.S." },
      { name: "Arum Abrori" },
      { name: "Gibran Tauchid Wionanda Putra" },
      { name: "Yakhya Nahnul Saputro" },
      { name: "Rahajeng Yusita" },
      { name: "Raihan Alfarisi" },
      { name: "Elmifta Yuana" },
      { name: "Sa'idah Layli Romadhoni" },
    ],
  },
  {
    id: "pit",
    ...
    staff: [
      ...
      { name: "Dewi Ayu Alamanda Purnama" },
      { name: "Kenneth Clinton Waworuntu" },
    ],
  },
  {
    id: "adkeu",
    ...
    staff: [
      { name: "Elvaretta Rizky Laverda" },
      { name: "Arbaliyah Puspita R" },
  ...
  },
  {
    ...
    core: [
      {
        name: "Muhammad Ibrahim Kumail",
        role: "Kabiro Medkominfo",
      },
      { name: "Randy Christian Saputra", role: "Wakabag Media Kreatif" },
      {
    ...
    staff: [
      ...
      { name: "Luvita Intan Cahyani" },
      { name: "Alexander Rama Giofran" },
      { name: "Bintang" },
      { name: "Yazid Ananda" },
      { name: "Tetron Jaguar Dasamuka" },
      { name: "Radya Farrel Pamesthi" },
      { name: "Cesilia Natasya Nainggolan" },
      { name: "Lyra Hertin" },
    ],
  },
];
